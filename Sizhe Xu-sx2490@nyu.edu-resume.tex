...
\section{Research}
  \resumeSubHeadingListStart
    \resumeLongTitleSubheading
      {Abstain Mask Retain Core: Time Series Prediction by Adaptive Masking Loss \paper{https://github.com/MazelTovy/AMRC}}{High Score at NeurIPS}
    ...
    \resumeItemListStart
      ...
      {Achieved significant improvements across multiple datasets; over 50\% of samples exhibited improved predictive performance while effectively suppressing redundant feature learning.}
    \resumeItemListEnd
    ...
    \resumeSubheading
      {Urban Mobility Prediction for Commercial Site Selection}{Guided Study}
    ...
    \resumeItemListStart
      ...
      {Designed scalable ETL pipeline for processing and integrating 15+ diverse educational datasets; implemented data quality monitoring with Great Expectations and optimized PostGIS queries for spatial joins.}
      \resumeItem{Geospatial Analysis}
      {Developed interactive platform visualizing geographic and school performance data; implemented Gemini-powered recommendation system for personalized school selection advice.}
    \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{SnowFox Technology Co., Ltd.}{Remote}
        ...
        {Created real-time biomechanical analysis pipeline with Unity HDRP renderer, IK solver optimization, and TensorFlow Lite for edge-deployed BiRNN movement classification (96.4\% accuracy); integrated performance metrics dashboard and RESTful API for cloud synchronization through AWS IoT Core.}
        \resumeItem{Impact}
        {Deployed at 5 ski resorts, increasing user 
        satisfaction by 50\% and expanding customer 
        base over 1,000 users.}
		\resumeItemListEnd
\resumeSubHeadingListEnd
